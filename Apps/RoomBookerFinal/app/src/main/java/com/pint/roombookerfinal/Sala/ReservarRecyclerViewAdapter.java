...
public class ReservarRecyclerViewAdapter extends
    ...
    public void createDialogReservar(Context mCtx, Reserva reserva){
        ...
        if(ed_num_pessoas.getText()!=null && ed_data_reserva.getText()!=null && ed_hora_inicio.getText()!=null
                && ed_hora_fim.getText()!=null
                && num_pessoas<lotacao)
        {
            ...
            Toast.makeText(mCtx, "Verifique que preencheu todos os campos corretamente",
