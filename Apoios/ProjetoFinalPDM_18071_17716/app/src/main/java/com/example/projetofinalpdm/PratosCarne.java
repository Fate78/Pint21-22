...
public class PratosCarne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pratos_carne);
        lv_carne = findViewById(R.id.lv_carne);
        Bundle extras = getIntent().getExtras();
        insertedid = extras.getLong("idinserted");
        List<Map<String, String>> lista = dataBaseHandler.getProductcarne();
        ...
        lv_carne.setAdapter(adapter);
        lv_carne.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
