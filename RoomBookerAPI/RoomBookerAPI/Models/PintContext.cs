...
namespace RoomBookerAPI.Models
{
    public partial class PintContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-LODJ3UU;Database=Pint;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CentroGeografico>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeCentro, "UQ__CENTRO_G__C618F5F604FDE2DC")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoUtilizador>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdTipo, "UQ__TIPO_UTI__DB4DE8AA897E136F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Utilizador>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__UTILIZAD__161CF724B31C20BF")
                    .IsUnique();

                entity.HasIndex(e => e.NomeUtilizador, "UQ__UTILIZAD__E28486C9A4202EE1")
                    .IsUnique();
